...
/**
 * localgroupfiles FieldType Constructor
 * @extends Field
 * @api public
 */

function localgroupfiles(list, path, options) {
	...
	if (options.initial) {
		throw new Error('Invalid Configuration\n\n' +
			'localgroupfiles fields (' + list.key + '.' + path + ') do not currently support being used as initial fields.\n');
	}
	...
	localgroupfiles.super_.call(this, list, path, options);

	// validate destination dir
	if (!options.dest) {
		throw new Error('Invalid Configuration\n\n' +
			'localgroupfiles fields (' + list.key + '.' + path + ') require the "dest" option to be set.');
	}
...
util.inherits(localgroupfiles, super_);
...
localgroupfiles.prototype.addToSchema = function() {
	...
	var schemaMethods = {
		...
		/**
		 * Deletes the file from localgroupfiles and resets the field
		 *
		 * @api public
		 */
...
localgroupfiles.prototype.format = function(item, i) {
...
localgroupfiles.prototype.hasFormatter = function() {
...
localgroupfiles.prototype.href = function(file) {
...
localgroupfiles.prototype.isModified = function(item) {
...
localgroupfiles.prototype.validateInput = function(data) {//eslint-disable-line no-unused-vars
...
localgroupfiles.prototype.updateItem = function(item, data) {//eslint-disable-line no-unused-vars
...
localgroupfiles.prototype.uploadFiles = function(item, files, update, callback) {
 ...
 * - `field.paths.upload` in `req.files` (uploads the file to localgroupfiles)
 *
 * @api public
 */

localgroupfiles.prototype.getRequestHandler = function(item, req, paths, callback) {
...
localgroupfiles.prototype.handleRequest = function(item, req, paths, callback) {
...
exports = module.exports = localgroupfiles;
